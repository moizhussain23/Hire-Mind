...
const Login = () => {
        ...
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left space-y-8 hidden lg:block">
            ...
            <p className="text-xl text-white/80 leading-relaxed max-w-lg">
              Sign in to continue transforming the way you hire, or start your
              journey to getting hired. Experience smarter, faster, and fairer
              interviews.
            </p>
          ...
          <div className="relative">
            ...
            >
              ...
              <p className="text-white/70 text-center mb-8">
                Continue your journey with HIRE MIND
              </p>
  ...
  variables: {
    ...
    // Make Email code block match social buttons
    ...
    footerActionLink: "text-purple-300 hover:text-purple-100 text-base font-bold",
  },
}}
